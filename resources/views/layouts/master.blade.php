...
<head>
    ...
    <script src="{{ asset('https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/js/all.min.js') }}"
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="{{ url('staticLayout') }}">Static Navigation</a>
                                <a class="nav-link" href="{{ url('lightLayout') }}">Light Sidenav</a>
                            </nav>
                        </div>
        ...
        <script src="{{ asset('https://cdn.datatables.net/1.10.20/js/jquery.dataTables.min.js') }}"
            crossorigin="anonymous"></script>
        <script src="{{ asset('https://cdn.datatables.net/1.10.20/js/dataTables.bootstrap4.min.js') }}"
            crossorigin="anonymous"></script>
